...
cur.execute(
    'SELECT %s.Feature,%s.C,%s.M,%s.S FROM %s left join %s ON %s.Feature = %s.Feature where %s.Feature is null' % (
    table1, table1, table1, table1, table1, table2, table1, table2, table2))
